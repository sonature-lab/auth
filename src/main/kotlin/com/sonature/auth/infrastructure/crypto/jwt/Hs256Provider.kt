...
class Hs256Provider(
    ...
    override fun supportedAlgorithm(): Algorithm = Algorithm.HS256

    override fun issue(claims: TokenClaims, config: TokenConfig): String {
        val signingKey = keyManager.getSigningKey(Algorithm.HS256) as SecretKey
    ...
    override fun verify(token: String): TokenClaims {
        val verificationKey = keyManager.getVerificationKey(Algorithm.HS256) as SecretKey
